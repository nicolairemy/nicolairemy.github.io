    ...
    !y(u, "undefined") && !y(u.call, "undefined") ? v = function(a, b) {
        ...
        try {
            if (c = !!a.canPlayType) c = new Boolean(c), c.ogg = a.canPlayType(
                ...
                c.h264 = a.canPlayType(
                    'video/mp4; codecs="avc1.42E01E"').replace(/^no$/,
                    ""), c.webm = a.canPlayType(
    ...
    return e.addTest = function(a, b) {
            if (typeof a == "object")
                ...
                b = typeof b == "function" ? b() : b, typeof f !=
                    "undefined" && f && (g.className += " w-mod-" + (b ? "" :
                        "no-") + a), e[a] = b
            }
            return e
        }, w(""), i = k = null,
        function(a, b) {
            ...
            function o(a, c, d) {
                ...
                d || (d = n(c));
                var g;
                return d.cache[a] ? g = d.cache[a].cloneNode() : f.test(
                        a) ? g = (d.cache[a] = d.createElem(a)).cloneNode() :
            ...
            function q(a, b) {
                b.cache || (b.cache = {}, b.createElem = a.createElement,
                    ...
                    return s.shivMethods ? o(c, a, b) : b.createElem(
                        c)
            ...
            function r(a) {
                a || (a = b);
                var c = n(a);
                return s.shivCSS && !g && !c.hasCSS && (c.hasCSS = !!l(
                    a,
        ...
        g.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + (f ?
            " w-mod-js w-mod-" + q.join(" w-mod-") : ""), e
}(this, this.document);
/**
